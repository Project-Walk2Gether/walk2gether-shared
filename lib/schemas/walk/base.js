...
exports.walkBaseSchema = yup.object({
    ...
    startLocation: location_1.locationSchema,
    ...
    isSharedWithFriends: yup.boolean(),
    sharedWithFriendIds: yup.array().of(yup.string().required()),
    startedAt: timestamp_1.timestampSchema,
